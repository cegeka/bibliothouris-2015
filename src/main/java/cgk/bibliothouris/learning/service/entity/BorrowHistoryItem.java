...
@NamedQueries({
        ...
        @NamedQuery(name=BorrowHistoryItem.COUNT_ALL_OVERDUE_BOOKS, query="SELECT COUNT(b.id) from BorrowHistoryItem b where (CURRENT_DATE - to_date(b.startDate) > :daysNo)"),

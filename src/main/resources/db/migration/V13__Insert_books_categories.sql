...
VALUES
  (BOOK_SEQUENCE.nextVal,
   ...
   'Even bad code can function. But if code isn’t clean, it can bring a development organization '
      ...
      || 'written code. But it doesn’t have to be that way. This book is a must for any developer, '
...
VALUES
  (BOOK_SEQUENCE.nextVal,
   ...
   'What others in the trenches say about The Pragmatic Programmer..."The cool thing about '
      ...
      || 'grab a copy. This is a book I would never loan because I would worry about it being lost." '
...
VALUES
  (BOOK_SEQUENCE.nextVal,
   ...
   'Refactoring is about improving the design of existing code. It is the process of changing a software '
      ...
      || 'take a bad design and rework it into a good one. This book offers a thorough discussion '
...
VALUES
  (BOOK_SEQUENCE.nextVal,
   ...
   'Design Patterns',
      ...
      || 'Previously undocumented, these 23 patterns allow designers to create more flexible, elegant, and ultimately '
...
VALUES
  (BOOK_SEQUENCE.nextVal,
   ...
   'Effective Java',
      ...
      || 'features introduced since the first edition. Bloch explores new design patterns and '
